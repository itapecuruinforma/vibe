...
const BOT_EMAIL        = process.env.BOT_ENIGMAS_EMAIL;
const BOT_PASSWORD     = process.env.BOT_ENIGMAS_PASSWORD;
...
async function main() {
  ...
  if (!FIREBASE_API_KEY || !BOT_EMAIL || !BOT_PASSWORD) {
    throw new Error('Variáveis de ambiente faltando: FIREBASE_API_KEY, BOT_ENIGMAS_EMAIL, BOT_ENIGMAS_PASSWORD');
  }
