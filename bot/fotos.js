...
const TEMAS = [
  ...
  { query: 'coffee cozy',         tag: 'cafe',       legenda: 'Um bom café resolve metade dos problemas. A outra metade a gente vê depois. ☕' },
  { query: 'flowers bloom',       tag: 'flores',     legenda: 'Floresça no seu tempo. Ninguém apressa uma primavera. 🌸' },
  { query: 'city architecture',   tag: 'cidade',     legenda: 'Cada cidade guarda mil histórias acontecendo ao mesmo tempo. 🏙️' },
  ...
  { query: 'cute animals',        tag: 'animais',    legenda: 'Uma dose de fofura pra deixar o dia mais leve. 🐾' },
